...
def baseTemplate(body) {
    podTemplate(label: 'jenkins-pipeline', idleMinutes: 1440, containers: [
        ...
        containerTemplate(name: 'mvn', image: 'maven:3-jdk-10', command: 'cat', ttyEnabled: true),
        containerTemplate(name: 'golang', image: 'imduffy15/docker-golang:0.0.1', command: 'cat', ttyEnabled: true),
